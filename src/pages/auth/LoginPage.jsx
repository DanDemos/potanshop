...
export default function LoginPage() {
  ...
  return (
    <>
      {
        <>
          <LoadingComponent loadingGroup={1}>
            <h1>Shazam!! I am fully charged</h1>
          </LoadingComponent>
          <LoadingComponent
            loadingGroup={"g"}
            loadingDesign={<h1>ooooooooooo</h1>}
          ></LoadingComponent>
        </>
      }
      ...
      <br />
      <button onClick={login2}>call api2</button>
      <br />
